...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('main/main.html',
    '<div class="col-lg-8 col-lg-offset-2 col-md-6 col-md-offset-3"><div class="col-xs-12"><div class="col-xs-2" style="margin-top : 10px"><span class="fa-stack fa-lg" style="cursor : pointer; color : #073F97; margin-top : 5px" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-bars fa-stack-1x fa-inverse"></i></span></div><div class="col-xs-8"><h3 style="color : #073F97; margin-top : 0px" class="text-center">SimpliCity</h3><h5 class="text-center">city data simplified</h5></div><div class="col-xs-2" style="margin-top : 10px"><img class="pull-right" style="height : 45px;" src="http://123graffitifree.com/images/citylogo-flatblue.png"></div></div><div class="col-xs-12"><p class=" text-muted text-center lead" style="margin-bottom : 0px; margin-top : 20px">Discover city data about places in your community.</p><p class=" text-muted text-center lead">Search for an address, street, neighborhood, or property to get started!</p></div><div class="input-group"><input id="inputSearch" tabindex="1" type="text" autocomplete="on" class="form-control" placeholder="Enter a location..." style="z-index: 0" ng-model="typedLocation" ng-focus="getAddressCandidates(typedLocation, $event)" ng-keyup="getAddressCandidates(typedLocation, $event)"> <span class="input-group-btn"><button class="btn btn-primary" type="button" style="box-shadow : none"><i class="fa fa-search"></i></button></span></div><div class="" ng-show="errorMessage.show || helperMessage.show || tabs.length > 0"><p ng-show="errorMessage.show" class="text-danger">{{errorMessage.message}}</p><p ng-show="helperMessage.show" class="text-success">{{helperMessage.message}}</p><div ng-repeat="tab in tabs"><div class="col-xs-12" style="margin-top : 10px; margin-bottom : 10px"><h4 class="row text-muted"><span ng-if="tab.label === \'Addresses\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-home fa-stack-1x fa-inverse"></i></span> <span ng-if="tab.label === \'Streets\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-road fa-stack-1x fa-inverse"></i></span> <span ng-if="tab.label === \'Neighborhoods\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i></span> <span ng-if="tab.label === \'Owners\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-user fa-stack-1x fa-inverse"></i></span> <span ng-if="tab.label === \'Civic Address IDs\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-cube fa-stack-1x fa-inverse"></i></span> <strong>{{tab.label}}</strong> <span class="badge" style="background : #999">{{tab.results.length}}</span></h4><div class="list-group" ng-repeat="candidate in tab.results"><a ng-click="getIdProperties(candidate, $event)" ng-keypress="getIdProperties(candidate, $event)" class="row list-group-item"><p class="col-xs-10 text-primary" style="margin : 0px"><span ng-if="tab.label === \'Addresses\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-home fa-stack-1x fa-inverse"></i></span> <span ng-if="tab.label === \'Streets\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-road fa-stack-1x fa-inverse"></i></span> <span ng-if="tab.label === \'Neighborhoods\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i></span> <span ng-if="tab.label === \'Owners\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-user fa-stack-1x fa-inverse"></i></span> <span ng-if="tab.label === \'Civic Address IDs\'" class="fa-stack fa-lg" ng-click="goBack()"><i class="fa fa-circle fa-stack-2x"></i> <i class="fa fa-cube fa-stack-1x fa-inverse"></i></span> {{candidate.attributes.Match_addr}}</p><h4 class="col-xs-2"><i class="fa fa-lg fa-chevron-right text-primary pull-right"></i></h4></a></div><div class="list-group"><a ng-click="getIdProperties(candidate, $event)" ng-keypress="getIdProperties(candidate, $event)" class="row list-group-item"><h4 class="col-xs-10 text-primary"><strong>More</strong></h4><h4 class="col-xs-2"><i class="fa fa-lg fa-chevron-down text-primary pull-right"></i></h4></a></div></div></div><p ng-show="errorMessage.show" class="text-danger">{{errorMessage.message}}</p></div></div>');
}]);
})();
